                ...
                <form action="{{ route('payment.payment_systems.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="exampleFormControlSelect1" name="status">
                            ...
                            <option @if(old('status') == \Teamprodev\LaravelPayment\Models\PaymentSystem::NOT_ACTIVE) selected @endif>{{ \Teamprodev\LaravelPayment\Models\PaymentSystem::NOT_ACTIVE }}</option>
                        </select>
                    </div>
