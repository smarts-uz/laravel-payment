...
namespace Teamprodev\LaravelPayment\Http\Classes\Payme;
...
use Teamprodev\LaravelPayment\Http\Classes\BaseGateway;
...
class Payme extends BaseGateway
{
    ...
    /**
     * @throws \Teamprodev\LaravelPayment\Http\Classes\PaymentException
     */
